...
export { ActorTypeEnum, BaseEntityEnum, IBaseEntityModel as BaseEntityModel, IBasePerTenantAndOrganizationEntityModel, IBasePerTenantEntityModel, IBaseRelationsEntityModel, IBaseSoftDeleteEntityModel, ID, JsonData, IBasePerEntityType } from './lib/base-entity.model';
